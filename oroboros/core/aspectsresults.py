...
class InterMidPointAspectData(MidPointAspectData):
    ...
    data1 = property(
        MidPointAspectData._get_data1,
        MidPointAspectData._set_data1,
        doc='Midpoint data.')
    data2 = property(_get_data2, _set_data2,
                     doc='Planet data.')
    aspect = property(
        MidPointAspectData._get_aspect,
        MidPointAspectData._set_aspect,
        doc='Aspect object.')
    diff = property(MidPointAspectData._get_diff, MidPointAspectData._set_diff,
                    doc='Difference.')
    apply = property(
        MidPointAspectData._get_apply,
        MidPointAspectData._set_apply,
        doc='Apply flag.')
    factor = property(
        MidPointAspectData._get_factor,
        MidPointAspectData._set_factor,
        doc='Strength factor.')
