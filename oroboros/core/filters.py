...
class Filter(db.Object):
    ...
    def set(
        ...
        if sid_t0 is not None:
            self.sid_t0 = sid_t0
        if sid_ayan_t0 is not None:
            self.sid_ayan_t0 = sid_ayan_t0
        if true_pos is not None:
            self.true_pos = true_pos
        if xcentric is not None:
            self.xcentric = xcentric
        if calc_midp is not None:
            self.calc_midp = calc_midp
        if draw_midp is not None:
        ...
        if orbs is not None:
            self.orbs = orbs
        if asprestr is not None:
            self.asprestr = asprestr
        if orbrestr is not None:
    ...
    def _insert(self, recursive=False):
        ...
        var = (
            ...
            self._aspects._idx_,
            self._orbs._idx_,
            self._asprestr._idx_,
            self._orbrestr._idx_,
            self._midpoints._idx_,
            self._comment)
