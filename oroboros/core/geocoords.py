...
class _Coords(object):
    ...
    def __float__(self):
        ...
        if self._direction in ('N', 'E'):
            ...
            dir = '-'
        return float('%s%s' % (dir, str(self._degrees +
                                        (self._minutes / 60.0) + (self._seconds / 3600.0))))
    ...
    def to_decimal(self):
        ...
        if self._direction in ('N', 'E'):
            ...
            dir = '-'
        return Decimal('%s%s' % (
            dir, str(self._degrees + (self._minutes / 60.0) + (self._seconds / 3600.0))))
    ...
    def from_decimal(self, value):
        ...
        sec = int((dec - (Decimal(str(mins)) / Decimal('60.0')))
                  * Decimal('3600.0'))
