...
class BiChart(list):
    ...
    def _get_intermidpoints(self):
        ...
        """
        if self._intermidpoints is None:
            ...
            for pos2 in self[1]._planets:
                ...
                for asp, doasp in f1._aspects.items():
                    ...
                    if not f2._aspects[asp]:
                        continue
                    if not f1._asprestr[
                            p1._name] or not f2._asprestr[
                            p1._name]:
                        continue
                    if not f2._asprestr[
                            p2._name] or not f2._asprestr[
                            p2._name]:
                        continue
                    asp = all_asp[asp]
