...
class AspectsRestrictionsManagerDialog(QDialog):
    ...
    def deleteFilterEvent(self):
        ...
        ret = QMessageBox.warning(
            self,
            tr('Delete Aspects Restrictions'),
            unicode(
                tr('Are you sure you want to delete aspects restrictions \xab %(filter)s \xbb ?')) % {
                'filter': name},
        ...
        if ret == QMessageBox.Yes:
            ...
            try:
                ...
                QMessageBox.critical(self, tr('Required Aspects Restrictions'), tr(
                    'Cannot delete required aspects restrictions.'))
            self.reset()
