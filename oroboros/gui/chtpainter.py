    ...
    def __init__(self, device, chart):
        ...
        if lenvisible == 1:
            ...
            if self._chart[0]._filter._draw_midp:
                self.draw_planets(
                    0, lenvisible, self._chart._all_draw_planets(0))
            else:
                self.draw_planets(
                    0, lenvisible, visible[0]._all_draw_planets())
            if self._chart[1]._filter._draw_midp:
                self.draw_planets(
                    1, lenvisible, self._chart._all_draw_planets(1))
            else:
                self.draw_planets(
                    1, lenvisible, visible[1]._all_draw_planets())
