...
class ChartInfoDialog(QDialog):
    ...
    def __init__(self, idx=-1, num=0, parent=None):
        ...
        # zoneinfo
        lbl = QLabel(
            tr('<a href="http://en.wikipedia.org/wiki/List_of_zoneinfo_timezones">Zoneinfo</a>'))
        ...
        # timezone
        lbl = QLabel(
            tr('<a href="http://upload.wikimedia.org/wikipedia/en/e/e7/Timezones2008.png">Timezone</a>'))
    ...
    def reset(self):
        ...
        # dst
        if self._chart._dst is None:
            self.dstEdit.setCurrentIndex(0)
        elif self._chart._dst:
        ...
        # utc offset
        if self._chart._utcoffset is not None:
